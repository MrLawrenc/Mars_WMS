...
<%--===================================================================--%>
<s:form id="searchForm" namespace="/" action="${objName}.action" method="post">
    <div id="container">
        <div class="ui_content">
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_bottom">
                        <s:url var="add" namespace="/" action="${objName}_input">
                        </s:url>
                ...
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <s:iterator value="#pageResult.result">
                        <tr>
                            ...
                            <td>
                                <s:url var="editURL" namespace="/" action="${objName}_input">
                                    <s:param name="${objName}.id" value="id"/>
                                </s:url>
                                <a href="<s:property value="#editURL"/>">编辑</a>

                                <s:url var="deleteURL" namespace="/" action="${objName}_delete">
                                    <s:param name="${objName}.id" value="id"/>
                                </s:url>
