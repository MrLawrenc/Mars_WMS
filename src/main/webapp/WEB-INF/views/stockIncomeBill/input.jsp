        ...
        $(function () {
            ...
            $(".btn_submit").click(function () {
                ...
                $.each($("#edit_table_body tr"), function (index, item) {
                    var copyTr = $(item);
                    copyTr.find("[tag=pid]").prop("name", "stockIncomeBill.items[" + index + "].product.id");
                    copyTr.find("[tag=costPrice]").prop("name", "stockIncomeBill.items[" + index + "].costPrice");
                    copyTr.find("[tag=number]").prop("name", "stockIncomeBill.items[" + index + "].number");
                    copyTr.find("[tag=remark]").prop("name", "stockIncomeBill.items[" + index + "].remark ");
                });
                //提交表单
                $("#editForm").submit();
            });
    ...
    <div id="container">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    <td class="ui_text_rt" width="140">入库的仓库</td>
                    <td class="ui_text_lt">
