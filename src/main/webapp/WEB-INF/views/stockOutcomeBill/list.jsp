...
<%--===================================================================--%>
<s:form id="searchForm" namespace="/" action="stockOutcomeBill.action" method="post">
    <div id="container">
            ...
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_center">
                        ...
                        客户 <s:select list="#clients" name="qo.clientId" listKey="id" listValue="name"
                                     cssClass="ui_select01" headerKey="-1" headerValue="全部"></s:select>
                        订单状态<s:select list="#{ -1:'全部',0:'未审核',1:'已审核'}" name="qo.status"
                                      style="height:30px"></s:select>
                    </div>
                    <div id="box_bottom">
                        <s:url var="add" namespace="/" action="stockOutcomeBill_input">
                        </s:url>
